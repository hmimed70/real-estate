 ...
 if (isset($_POST['submit'])) {
  ...
  // if not error
   if(empty($emailErr) && empty($passErr)) {
       ...
       $result = mysqli_query($conn,"SELECT * FROM admin  WHERE email = '$email' and pass_admin = '$pass' ");
      ...
      <div class="home-inner container">
        <div class="col-md-6  login-form-1" style="float:none;margin:auto;">
          ...
          <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post">
            ...
            <div class="form-group">
              <span> you didn't have account ? <a href="signup_admin.php" class="signup-link">sign up here</a>
            </div>
            <?php if(!empty($error)) {
